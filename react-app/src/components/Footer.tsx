...
// Brand glyph paths (24×24, simple-icons). Set href to the real profile URL
// when the owner provides their social handles — "#" renders a non-clickable badge.
